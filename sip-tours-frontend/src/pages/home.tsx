        ...
        <>
          ...
          >
            ...
            <Row style={{ width: "92vw", marginInline: "auto", marginBottom: "3vh" }}>
              ...
              <h3 className="p-home-mobile" style={{ marginTop: "2vh", textAlign: "justify" }}>{"Discover the authentic flavors of Portugal on our Food & Wine Tours in Lisbon's oldest neighborhood. Indulge in a variety of local wines, including red, white, palhete, and fortified varietals, along with the famous ''ginjinha'' liqueur. We'll also take you to some of the most historic landmarks and traditional restaurants, where you'll have the chance to experience the local culture and cuisine firsthand. With our expert guides, you are guaranteed an unforgettable gastronomic journey!"}</h3>
            </Row>
            <Row style={{ width: "100vw", marginInline: "auto", display: "flex", flexDirection: "row", marginBottom: "18vh", alignContent: "center", justifyContent: "center", alignItems: "center" }}>
              <Button
                className="button-rounded-black-mobile clickable"
          ...
          <>
            ...
            <Layout fullWidth backgroundColor={ThemeColor.whiteHome} backgroundStyle={{ paddingTop: "10vw" }}>
              ...
              <Row style={{ display: "flex", flexDirection: "row", width: "90vw", marginInline: "auto" }}>
                ...
                <Col style={{ width: "52%" }}>
                  <p className="p-home" style={{ textAlign: "justify" }}>{"Discover the authentic flavors of Portugal on our Food & Wine Tours in Lisbon's oldest neighborhood. Indulge in a variety of local wines, including red, white, palhete, and fortified varietals, along with the famous ''ginjinha'' liqueur. We'll also take you to some of the most historic landmarks and traditional restaurants, where you'll have the chance to experience the local culture and cuisine firsthand. With our expert guides, you are guaranteed an unforgettable gastronomic journey!"}</p>
                </Col>
              </Row>
