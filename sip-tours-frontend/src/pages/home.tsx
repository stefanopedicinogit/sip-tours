      ...
      {isMobile ? (<><HeaderHome />
        ...
        >
          ...
          <Row style={{ width: "92vw", marginInline: "auto", marginTop: "3vh" }}>
            <h1 className="h1-home-mobile">PORTUGUESE WINE & FOOD EXPERIENCES</h1>
          ...
          <Row style={{ width: "92vw", marginInline: "auto", marginBottom: "3vh" }}>
            ...
            <h3 className="p-home-mobile" style={{ marginTop: "2vh" }}>Discover the authentic flavors of Portugal on our Wine & Food Tours in Lisbon's oldest neighborhood. Indulge in a variety of local wines, including red, white, palhete, and fortified varietals, along with the famous "ginjinha" liqueur. We'll also take you to some of the most historic landmarks and traditional restaurants where you'll have the chance to experience the local culture and cuisine. With our expert guides, you are guaranteed an unforgettable gastronomic journey.</h3>
          </Row>
          <Row style={{ width: "100vw", marginInline: "auto", display: "flex", flexDirection: "row", marginBottom: "18vh", alignContent: "center", justifyContent: "center", alignItems: "center" }}>
            <Button
              className="button-rounded-black-mobile clickable">
          ...
          <Row style={{ width: "92vw", marginInline: "auto", marginBottom: "3vh" }}>
            <h1 className="h1-home-mobile" style={{ textDecoration: "underline" }}>GLIMPSE OF SIP</h1>
          </Row>
          <Row style={{ width: "100vw", marginInline: "auto", display: "flex", flexDirection: "row", marginTop: "3vh", marginBottom: "8vh", alignContent: "center", justifyContent: "center", alignItems: "center" }}>
            <Button
              className="button-rounded-black-mobile clickable">
          ...
          <Row style={{ width: "92vw", marginInline: "auto", marginBottom: "3vh" }}>
            <Image
              src="/HomeMobile4.webp"
              alt="Sip Tours Home Page"
              style={{ width: "100%", height: "auto" }}
            />
          </Row>
          <Row style={{ width: "92vw", marginInline: "auto", marginBottom: "3vh" }}>
            <h1 className="h1-home-mobile" style={{ textDecoration: "underline" }}>TRIP TO SINTRA</h1>
          </Row>
          <Row style={{ width: "100vw", marginInline: "auto", display: "flex", flexDirection: "row", marginTop: "3vh", marginBottom: "8vh", alignContent: "center", justifyContent: "center", alignItems: "center" }}>
            <Button
              className="button-rounded-black-mobile clickable">
